...
class SettingsWindow(xbmcgui.WindowXMLDialog):
    ...
    def onAction(self, action):
        ...
        elif Id in (ACTION_PARENT_DIR, ACTION_PREVIOUS_MENU):
            self.close()
        else:
            return False
