...
import logging
import colorsys
from common import get_html as fetch_url
...
class Downloader:
    ...
    def get_comment_text(self):
        return fetch_url(self.comment_url, decode=False)
...
class AcfunDownloader(Downloader):
    ...
    def get_html(self):
        return fetch_url(self.url, decode=False)
    ...
    def get_comment_url(self):
        ...
        try:
            video_uid = json.loads(fetch_url(info_url, decode=False))['cid']
        except KeyError:
            video_uid = vid
